  ...
  return (
    <div className="lg:col-span-1 flex flex-col gap-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <h3 className="text-base font-bold text-gray-900 mb-6">Job Overview</h3>
      ...
      <div className="bg-linear-to-br from-blue-600 to-blue-800 rounded-2xl shadow-md p-6 text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h3 className="text-lg font-bold mb-2">Want more applicants?</h3>
          <p className="text-blue-100 text-sm mb-6 leading-relaxed">
            Promote this job to reach up to 5x more qualified candidates in your
            area.
          </p>
          <button
            onClick={onPromote}
