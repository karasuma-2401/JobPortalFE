  ...
  return (
    <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-sm font-bold text-gray-900">Payment Card</h3>
        <button
          onClick={onEdit}
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-gray-900">{cardHolder}</p>
          </div>
        </div>
        <div className="text-right">
          ...
          <p className="text-sm font-bold text-gray-900">{expireDate}</p>
        </div>
      </div>
