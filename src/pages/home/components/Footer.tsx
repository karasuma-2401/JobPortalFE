        ...
        <footer className='bg-gray-900 text-gray-300 py-16 px-8'>
            <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8'>
                <div className='lg:col-span-2'>
                    ...
                    <p className='mb-4'>
                        Call now:{' '}
                        <span className='text-bg-white font-medium'>
                            +84-867-070-087
                        </span>
                    </p>
                    <p className='text-sm text-gray-500 leading-relaxed max-w-sm'>
                        University of Information and Technology, KP.6 Linh
                        Trung, T.P Ho Chi Minh
                    </p>
                </div>
                <div className='flex flex-col gap-4'>
                    <h3 className='text-bg-white font-medium text-lg mb-2'>
                        Quick Link
                    </h3>
                    <Link
                        to='#'
