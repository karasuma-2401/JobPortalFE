            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='border border-gray-100 rounded-lg overflow-hidden focus-within:border-primary-400 transition-all'>
                    ...
                    <div className='flex items-center gap-4 px-4 py-3 border-t border-gray-50 bg-gray-50/30'>
                        <span className='text-gray-400 font-bold hover:text-gray-600 cursor-pointer'>
                            B
                        </span>
                        <span className='text-gray-400 italic hover:text-gray-600 cursor-pointer'>
                            I
                        </span>
                        <span className='text-gray-400 underline hover:text-gray-600 cursor-pointer'>
                            U
                        </span>
                        <span className='text-gray-400 line-through hover:text-gray-600 cursor-pointer'>
                            S
                        </span>
                        <div className='w-[1px] h-4 bg-gray-200 mx-1' />
                        <span className='text-gray-400 hover:text-primary-500 cursor-pointer text-lg'>
                            🔗
                        </span>
                        <div className='w-[1px] h-4 bg-gray-200 mx-1' />
