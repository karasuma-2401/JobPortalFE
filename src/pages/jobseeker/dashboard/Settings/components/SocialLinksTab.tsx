...
const socialNetworks: OptionType[] = [
  { label: "Facebook", icon: <FaFacebook className="text-blue-600" />, value: "facebook" },
  { label: "Twitter", icon: <FaTwitter className="text-sky-500" />, value: "twitter" },
  { label: "Instagram", icon: <FaInstagram className="text-pink-600" />, value: "instagram" },
  { label: "Youtube", icon: <FaYoutube className="text-red-600" />, value: "youtube" },
  { label: "LinkedIn", icon: <FaLinkedin className="text-blue-700" />, value: "linkedin" },
];
