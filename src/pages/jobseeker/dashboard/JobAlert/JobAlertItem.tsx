import { MapPin, DollarSign, CalendarDays, Bookmark, ArrowRight } from "lucide-react";
...
const logoClearBit = (companyDomain: string) => `https://logo.clearbit.com/${companyDomain}`;
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              className={`text-[11px] font-extrabold px-3 py-1 rounded-full ${
                type === "Internship" ? "bg-orange-50 text-warning-500" : "bg-blue-50 text-primary-500"
              }`}
            >
              {type}
            </span>
      ...
      <div className="flex items-center gap-5">
        ...
        >
          <Bookmark size={20} className={logo.includes('reddit') ? 'fill-danger-500 text-danger-500' : ''}/>
        </button>
